...
const Company = () => {
    ...
    const timelineData = [
        ...
        {
            date: 'Jul 2024',
            title: 'FastTrack Software  Desktop 2.5 + Generator',
        ...
        },
        {
            ...
            description: 'Milestones added, deeply embedded into FastTrack Software  for matter tracking',
            icon: 'fas fa-tasks'
        },
        {
            date: 'Apr 2024',
            title: 'FastTrack Software  Desktop – Matter AI',
        ...
        {
            date: 'Mar 2024',
            title: 'FastTrack Software  Desktop – LawY AI Assistant',
    ...
    const partnerCategories = [
        {
            ...
            description: 'Expert consultants to help optimize your FastTrack Software  implementation',
            icon: 'fas fa-user-check'
        },
        {
            title: 'Bookkeepers',
            description: 'Qualified bookkeeping professionals familiar with FastTrack Software ',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                ...
                                innovative team dedicated to modern legal practice. At FastTrack Software , you'll be part of a company that's
                        ...
                        <div className="relative">
                            <div className="rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="FastTrack Software  Team Working"
                                    className="w-full h-full object-cover"
                                />
                            </div>
                        </div>
                    ...
                    <div className="text-center mb-16">
                        ...
                        <div className="bg-[#2c3e50] text-white rounded-2xl p-8 max-w-2xl mx-auto mb-12">
                            ...
                            <p className="text-gray-200">
                                FastTrack Software  reinvests annually into R&D, delivering cutting-edge technology and the world's best
                                        ...
                                        <div className={`overflow-hidden transition-all duration-300 ${activeTimelineItem === index ? 'max-h-96 opacity-100' : 'max-h-16 opacity-75'
                                            ...
                                            {activeTimelineItem === index && (
                                                <div className="mt-4 pt-4 border-t border-gray-100">
                                                    <a
                                                        href="https://community.FastTrack Software .co.uk"
                                                        className="text-[#f76b1c] hover:text-[#e65b0c] font-medium cursor-pointer"
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                    >
                                                        Learn more on community.FastTrack Software .co.uk <i className="fas fa-external-link-alt ml-1"></i>
                                                    </a>
                                                </div>
                                            )}
                                        </div>
                    ...
                    <div className="text-center">
                        <div className="bg-gradient-to-r from-[#2c3e50] to-[#2c3e50] rounded-2xl p-8 text-white">
                            ...
                            <p className="text-gray-200 mb-6 max-w-2xl mx-auto">
                                Join our partner network and help law firms maximize their potential with FastTrack Software .
                ...
                <div className="p-5 mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            ...
                            Help shape the future of FastTrack Software  together with our community.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gradient-to-br from-[#2c3e50]/5 to-[#2c3e50]/10 rounded-2xl p-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Engage with other FastTrack Software  users, share experiences, and learn from the community.
                            </p>
                            <button className="bg-[#f76b1c] text-white px-6 py-3 !rounded-button font-semibold hover:bg-[#e65b0c] transition-colors cursor-pointer whitespace-nowrap">
                                Join Discussion
                            </button>
