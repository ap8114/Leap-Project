...
const DocumentAutomation = () => {
  ...
  const faqs = [
    {
      question: "What is automated document creation in legal practice?",
      answer:
    ...
    {
      question: "What document systems are available for law firms?",
      answer:
    ...
    {
      question: "How should we select document automation software?",
      answer:
  ...
  const features = [
    {
      ...
      description:
        "Leverage artificial intelligence to streamline document creation and matter management processes.",
      icon: "ri-robot-line",
    },
    {
      title: "Legal Form Library",
      description:
        "Access thousands of up-to-date legal forms and precedents maintained by our expert team.",
      icon: "ri-file-text-line",
    },
    {
      title: "Matter Management",
      description:
        "Centralized system to track, organize, and manage all your legal matters efficiently.",
      icon: "ri-folder-line",
    },
    {
      title: "Document Security",
      description:
        "Enterprise-grade security with encrypted storage and controlled access permissions.",
    ...
    },
    {
      ...
      description:
        "Seamless integration with Microsoft 365, accounting software, and other legal tools.",
      icon: "ri-links-line",
    },
  ];
      ...
      <div className="bg-light">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100 leading-relaxed">
                  Thousands of up-to-date and integrated legal forms and
                  precedents out of the box let you work smarter, not harder.
                </p>
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md ml-auto">
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-dark-600 font-bold">
                        FastTrack UK
                      </span>
                    </div>
                  ...
                  <button
                    className="w-full   text-white py-3 rounded-lg font-semibold transition-colors cursor-pointer whitespace-nowrap"
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to run a modern law firm efficiently, from
                document automation to client management.
              </p>
            </div>
              ...
              {features.map((feature, index) => (
                <div key={index} className="col-12 col-md-6 col-lg-4">
                  <div className="bg-white p-4 rounded-4 shadow-sm border h-100 d-flex flex-column hover-shadow transition">
                    <div
                      className="d-flex align-items-center justify-content-center bg-custom bg-opacity-10 rounded-3 mb-4"
            ...
            <div className="row align-items-center g-5">
              ...
              <div className="col-lg-6">
                ...
                <p className="fs-5 text-muted mb-4">
                  FastTrack uses AI to intelligently examine your FastTrack
                  matter to provide instant insights and information. It
                  examines your correspondence to identify important data and
                  give a detailed response in seconds, generating
                  professional-quality documents in a fraction of the time. Ask
                  it anything.
                </p>
              ...
              <div className="col-lg-6 position-relative">
                ...
                <div
                  ...
                  style={{ bottom: "-2rem", left: "-2rem", maxWidth: "300px" }}
                >
                  ...
                  <p className="small text-muted mb-0">
                    Found 12 key insights in your correspondence and generated
                    draft response in 3.2 seconds.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container px-3 px-md-4">
            <div className="row align-items-center g-5">
              ...
              <div className="col-lg-6 order-1 order-lg-2">
                ...
                <p className="fs-5 text-muted mb-4">
                  Automate the generation of pre-populated legal forms and
                  precedents based on your matter data with no setup or ongoing
                  maintenance requirements. Our experienced team keeps the
                  library up-to-date, saving you time and eliminating the risk
                  of mistakes.
                </p>
                ...
                <div className="d-flex flex-column gap-3 mb-4">
                  <div className="d-flex align-items-center">
                    ...
                    <span className="text-dark">
                      Thousands of legal forms and precedents
                    </span>
                  </div>
                  <div className="d-flex align-items-center">
                    <div
                    ...
                    <span className="text-dark">
                      Automatically updated by legal experts
                    </span>
                  </div>
                  <div className="d-flex align-items-center">
                    <div
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  ...
                  maximises productivity and increases your billable time.
                  Easily assign documents and emails to matters, synchronise
                  your FastTrack documents across all your connected devices and
                  ...
                  {integrations.map((integration, index) => (
                    ...
                    >
                      <div className="w-10 h-10 flex items-center justify-center mr-3">
                        <i
                          className={`${integration.icon} text-2xl ${integration.color}`}
                        ></i>
                      </div>
        ...
        >
          <Container fluid className="px-lg-5">
            <h2 className="text-center mb-5">
              Key Features of Our Document Solution
            </h2>
            <Row>
              <Col md={6} lg={3} className="mb-4">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p>
                      Create consistent documents with matter details pre-filled
                    </p>
                  </div>
                </div>
              </Col>
        ...
        <section className="py-5 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <h2
              className="text-center mb-10 text-3xl font-bold"
              style={{ color: "#2c3e50" }}
            >
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 py-4 flex justify-between items-center text-left text-lg font-medium"
                    style={{ color: "#2c3e50" }}
                  >
                    {faq.question}
                    <svg
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto text-white">
              ...
              <p className="text-xl lg:text-2xl mb-12 text-blue-100 leading-relaxed">
                Join thousands of law firms who have already streamlined their
                operations with FastTrack's comprehensive legal practice
                management solution.
              </p>
