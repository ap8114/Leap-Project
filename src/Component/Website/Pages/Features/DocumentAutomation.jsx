                                ...
                                <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md ml-auto">
                                    <div className="mb-6">
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <span className="text-dark-600 font-bold">FastTrack Software UK</span>
                                        </div>
                        ...
                        <div className="row align-items-center g-5">
                            ...
                            <div className="col-lg-6">
                                ...
                                <p className="fs-5 text-muted mb-4">
                                    FastTrack Software uses AI to intelligently examine your FastTrack Software matter to provide instant insights and information.
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                    Seamless integration with Word, Excel, Outlook and Teams maximises productivity and increases your billable time. Easily assign documents and emails to matters, synchronise your FastTrack Software documents across all your connected devices and work collaboratively with your colleagues.
                                </p>
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center max-w-4xl mx-auto text-white">
                            ...
                            <p className="text-xl lg:text-2xl mb-12 text-blue-100 leading-relaxed">
                                Join thousands of law firms who have already streamlined their operations with FastTrack Software's comprehensive legal practice management solution.
                            </p>
