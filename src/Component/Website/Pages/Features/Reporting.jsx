          ...
          <div className="container">
            ...
            <div className="row align-items-center mb-5">
              <div className="col-md-6 order-md-2 ps-4 mb-4 mb-md-0">
                ...
                <p className="lead text-muted mb-4">
                  FastTrack's integrated firm and staff reports provide valuable data to monitor individual performance and manage the firm.
                </p>
                <p className="lead text-muted">
                  Through the FastTrack Connector for Power BI, gain a deeper understanding of trends, performance, and profitability out of the box.
                </p>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-md-6 pe-4 mb-4 mb-md-0">
                ...
                <p className="lead text-muted mb-4">
                  FastTrack enables automatic delivery of essential information at set intervals. You can easily schedule recurring reports to be generated and distributed at specified times, saving time and enhancing efficiency by eliminating manual reporting tasks.
                </p>
                <p className="lead text-muted">
