    ...
    <div className="W-100">
        ...
        <Container>
          ...
          <Card className="shadow-lg">
            ...
            <Card.Body>
              ...
              {activeTab === 'documents' && (
                <div>
                  <Card className="border-2 border-dashed text-center p-5 mb-4">
        ...
        <Container>
          ...
          <Row className="g-4">
            ...
            <Col md={6} lg={4}>
              <Card className="h-100 shadow-sm border-0">
                <Card.Body>
                  <div className="bg-dark text-white rounded p-3 mb-4 d-inline-flex">
      ...
      <section className="py-5 bg-dark text-white">
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="mb-5 mb-lg-0">
              <h2 className="display-5 fw-bold mb-4">Ready to transform your family law practice?</h2>
              <p className="lead text-muted mb-4">
