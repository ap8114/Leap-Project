          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-5 mb-lg-0">
              ...
              <div className="d-flex flex-column flex-sm-row gap-3 mb-4">
                <button className="btn btn-lg px-4 py-3 fw-semibold text-white" style={{backgroundColor: '#f76b1c' , color: 'white'}}>
                  Start Free Trial
                </button>
                <button className="btn btn-lg px-4 py-3 fw-semibold" style={{color: '#f76b1c', borderColor: '#f76b1c'}}>
                  Watch Demo
                </button>
              </div>
              <div className="d-flex flex-wrap align-items-center gap-4 pt-3">
                <div className="d-flex align-items-center gap-2">
                  <div className="d-flex">
                    <div className="rounded-circle  d-flex align-items-center justify-content-center text-white fw-bold" style={{width: '32px', height: '32px', color: 'white', backgroundColor: '#f76b1c'}}>A</div>
                    <div className="rounded-circle  d-flex align-items-center justify-content-center text-white fw-bold ms-n2" style={{backgroundColor: '#f76b1c' , color: 'white', width: '32px', height: '32px'}}>B</div>
                    <div className="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold ms-n2" style={{width: '32px', height: '32px', backgroundColor: '#f76b1c' , color: 'white', }}>C</div>
                  </div>
              ...
              <div className="bg-white rounded-3 shadow-lg p-4 p-md-5">
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded mb-2">
                    ...
                    <span className="badge  small" style={{color: '#f76b1c'}}>In Progress</span>
                  </div>
                ...
                <div className="pt-2">
                  <div className="progress" style={{height: '8px'}}>
                    <div className="progress-bar " style={{backgroundColor: '#f76b1c' , color: 'white',width: '75%'}}></div>
                  </div>
            ...
            <div className="col-lg-6 mb-5 mb-lg-0">
              {features.map((feature, index) => (
                <div 
                  ...
                  className={`p-4 rounded-3 mb-4 cursor-pointer ${activeFeature === index ? 'bg-white shadow-lg border-start border-4' : 'bg-white shadow-sm'} ` }
                  onClick={() => setActiveFeature(index)}
                >
                  <div className="d-flex">
                    <div className={`rounded-2 flex-shrink-0 d-flex align-items-center justify-content-center ${activeFeature === index ? ' text-white' : 'bg-light text-muted'}`} style={{backgroundColor: '#f76b1c' , color: 'white',width: '48px', height: '48px'}}>
        ...
        <div className="container py-5">
          ...
          <div className="row text-center">
            <div className="col-6 col-md-3 mb-4 mb-md-0">
              <div className="display-4 fw-bold mb-2" style={{color: '#f76b1c'}}>10K+</div>
              <div className="text-light">Active Users</div>
            </div>
            <div className="col-6 col-md-3 mb-4 mb-md-0">
              <div className="display-4 fw-bold  mb-2" style={{color: '#f76b1c'}} >50K+</div>
              <div className="text-light">Transactions Processed</div>
            </div>
            <div className="col-6 col-md-3">
              <div className="display-4 fw-bold mb-2" style={{color: '#f76b1c'}}>99.9%</div>
              <div className="text-light">Uptime</div>
            </div>
            <div className="col-6 col-md-3">
              <div className="display-4 fw-bold  mb-2" style={{color: '#f76b1c'}}>24/7</div>
                ...
                <div className="bg-light rounded-3 p-4 h-100">
                  <div className="d-flex mb-3">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <i key={i} className="fa fa-star me-1" style={{color: '#f76b1c'}}></i>
                    ))}
                  </div>
                  <p className="text-muted mb-4 fst-italic">"{testimonial.content}"</p>
                  <div className="d-flex align-items-center mt-auto">
                    <div className="rounded-circle  d-flex align-items-center justify-content-center text-white fw-bold me-3" style={{backgroundColor: '#f76b1c' , color: 'white',width: '48px', height: '48px'}}>
                      {testimonial.avatar}
                    </div>
                    <div>
