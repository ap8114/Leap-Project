                        ...
                        <div className="col-12 col-lg-6">
                            <div className="features-card h-100 p-4 text-white">
                                <div className="position-relative mb-4">
                                    ...
                                    <h3 className="mb-3">Why Choose FastTrack Software?</h3>
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-top">
                                    <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                        <div>
                                            <h6 className="mb-1 text-white fw-semibold">Already using FastTrack Software?</h6>
                                        ...
                                        <div className="col-12">
                                            <div className="form-check">
                                                ...
                                                <label className="form-check-label" htmlFor="updates">
                                                    Keep me updated with FastTrack Software news and special offers
                                                </label>
                                            </div>
                                        </div>
                                        <div className="col-12">
