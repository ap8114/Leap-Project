                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4 border-start">
                                        <div className="mb-4 d-flex align-items-start">
                                            <img src="https://i.ibb.co/6y9wK3y/mobile-working.png" alt="Mobile Working" className="rounded-3 me-3" style={{ width: 90, height: 70, objectFit: 'cover' }} />
                                            <div>
                                                <div className="text-primary fw-semibold small mb-1">MOBILE WORKING</div>
                                                <div className="small text-muted">Work on your matters effectively away from the office on any device</div>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-start">
                                            <img src="https://i.ibb.co/6Jm1qkQ/integrations.png" alt="Apps & Integrations" className="rounded-3 me-3" style={{ width: 90, height: 70, objectFit: 'cover' }} />
                                            <div>
                                                <div className="text-primary fw-semibold small mb-1">APPS & INTEGRATIONS</div>
                                                <div className="small text-muted">Seamless integrations provide additional value to your LEAP subscription</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <div className="small text-muted">
                                                Discover how LEAP can help solicitors establish their own law firm
                                            </div>
                                        </div>
                                        <div>
                                            <strong>For mid-sized law firms</strong>
                                            <div className="small text-muted">
                                                Discover how LEAP can support larger law firms across every department
                                            </div>
                                        </div>
                                    </div>
                                    {/* Areas of Law */}
                                    <div className="col-5 border-start">
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                ...
                                                <a className="dropdown-item" href="#corporate">Corporate & Commercial</a>
                                                <a className="dropdown-item" href="#criminal">Criminal</a>
                                            ...
                                            <div className="col-6">
                                                ...
                                                <a className="dropdown-item" href="#immigration">Immigration</a>
                                                <a className="dropdown-item" href="#lifetime">Lifetime planning</a>
                                                <a className="dropdown-item" href="#personal-injury">Personal injury</a>
                                                <a className="dropdown-item" href="#specialist-litigation">Specialist litigation</a>
                                            </div>
                                        </div>
                                    </div>
                                    {/* Images and Info */}
                                    <div className="col-4 border-start">
                                        <div className="mb-4 d-flex align-items-start">
                                            <img src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=120&q=80" alt="Legal Aid" className="rounded-3 me-3" style={{ width: 70, height: 70, objectFit: 'cover' }} />
                                            <div>
                                                <div className="text-primary fw-semibold small mb-1">LEGAL AID</div>
                                                <div className="small text-muted">Streamline the way you carry out publicly funded work</div>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-start">
                                            <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=120&q=80" alt="Switch to LEAP" className="rounded-3 me-3" style={{ width: 70, height: 70, objectFit: 'cover' }} />
                                            <div>
                                                <div className="text-primary fw-semibold small mb-1">SWITCH TO LEAP</div>
                                                <div className="small text-muted">Discover why law firms are choosing LEAP</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        ...
                                        <a className="dropdown-item fw-semibold" href="#leadership">Leadership</a>
                                        <div className="small text-muted mb-2 ms-3">We understand that our greatest asset is our people</div>
                                        <a className="dropdown-item fw-semibold" href="#careers">Careers</a>
                                        <div className="small text-muted mb-2 ms-3">We care about what we do and the people we work with</div>
                                        <a className="dropdown-item fw-semibold" href="#innovations">Innovations</a>
                                        <div className="small text-muted ms-3">LEAP is the result of valuable feedback from users across the globe</div>
                                    </div>
                                    {/* Contact & Support */}
                                    <div className="col-3 border-start">
                                        <h6 className="dropdown-header text-primary">CONTACT & SUPPORT</h6>
                                        <a className="dropdown-item fw-semibold" href="#contactus">Contact us</a>
                                        <div className="small text-muted mb-2 ms-3">Get in touch to find out more about LEAP</div>
                                        <a className="dropdown-item fw-semibold" href="#support">Client Support</a>
                                        <div className="small text-muted mb-2 ms-3">Learn about our unlimited support and training options for LEAP users</div>
                                        <a className="dropdown-item fw-semibold" href="#helpcentre">LEAP Help Centre</a>
                                        <div className="small text-muted ms-3">Browse our articles, access support and engage with the LEAP Community</div>
                                    </div>
                                    {/* Business Partners */}
                                    <div className="col-3 border-start">
                                        <h6 className="dropdown-header text-primary">BUSINESS PARTNERS</h6>
                                        <a className="dropdown-item fw-semibold" href="#partners">Partner Network Directory</a>
                                        <div className="small text-muted mb-2 ms-3">Certified Consultants, Accounting, Bookkeepers and IT Partners</div>
                                        <a className="dropdown-item fw-semibold" href="#joinpartner">Join our Partner Network</a>
                                        <div className="small text-muted mb-2 ms-3">For individuals and companies skilled in providing support to law firms</div>
                                        <a className="dropdown-item fw-semibold" href="#lawsociety">The Law Society</a>
                                        <div className="small text-muted ms-3">Proud to be a strategic partner of The Law Society</div>
                                    </div>
                                    {/* Ideas Hub */}
                                    <div className="col-3 border-start">
                                        <div className="mb-3">
                                            <img src="https://i.ibb.co/4VwQyqF/ideas-hub.png" alt="Ideas Hub" className="rounded-3 mb-2" style={{ width: 120, height: 70, objectFit: 'cover' }} />
                                        </div>
                                        <div>
                                            <div className="text-primary fw-semibold small mb-1">IDEAS HUB</div>
                                            <div className="small text-muted">Provide feedback, read discussions and vote on improved LEAP features</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-3">
                                        ...
                                        <a className="dropdown-item fw-semibold" href="#testimonials">Testimonials</a>
                                        <div className="small text-muted mb-2 ms-3">Don't take our word for it, hear from our clients</div>
                                        <a className="dropdown-item fw-semibold" href="#brochures">Brochures and guides</a>
                                        <div className="small text-muted mb-2 ms-3">Learn more about how LEAP can improve your practice</div>
                                        <a className="dropdown-item fw-semibold" href="#whitepapers">White papers</a>
                                        <div className="small text-muted ms-3">Thought leadership articles to help you overcome challenges in your firm</div>
                                    </div>
                                    {/* Webinars & Events */}
                                    <div className="col-3 border-start">
                                        <h6 className="dropdown-header text-primary">WEBINARS & EVENTS</h6>
                                        <a className="dropdown-item fw-semibold" href="#events">Upcoming events & webinars</a>
                                        <div className="small text-muted ms-3">LEAP hosts and attends industry events both online and in person across the UK</div>
                                    </div>
                                    {/* Thought Leadership */}
                                    <div className="col-3 border-start">
                                        <h6 className="dropdown-header text-primary">THOUGHT LEADERSHIP</h6>
                                        <a className="dropdown-item fw-semibold" href="#blog">Blog</a>
                                        <div className="small text-muted mb-2 ms-3">Stay on top of emerging industry trends</div>
                                        <a className="dropdown-item fw-semibold" href="#linkedin">LinkedIn</a>
                                        <div className="small text-muted ms-3">Follow us to stay up-to-date on the latest developments at LEAP</div>
                                    </div>
                                    {/* Help Centre */}
                                    <div className="col-3 border-start">
                                        <div className="mb-3">
                                            <img src="https://i.ibb.co/4VwQyqF/ideas-hub.png" alt="LEAP Help Centre" className="rounded-3 mb-2" style={{ width: 120, height: 70, objectFit: 'cover' }} />
                                        </div>
                                        <div>
                                            <div className="text-primary fw-semibold small mb-1">LEAP HELP CENTRE</div>
                                            <div className="small text-muted">Browse our articles, access support and engage with the LEAP Community</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
