...
<Button
  ...
  <Dropdown.Menu
    className="p-3"
    style={{ minWidth: "600px", maxHeight: "400px", overflowY: "auto" }}
  >
    <Row>
      {/* === LEFT SIDE: Visible Columns Checkboxes === */}
      <Col md={6}>
        <h6 className="mb-2 fw-bold">Visible columns</h6>
...
{activeTab === "stages" && (
  <div className="border rounded p-3 bg-light">
    <Row className="align-items-center mb-3 flex-wrap gap-2">
      ...
      <Col md className="ms-auto d-flex gap-2 justify-content-end">
        <Form.Control
          type="text"
