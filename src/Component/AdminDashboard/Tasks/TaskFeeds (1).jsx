...
const TaskFeeds = () => {
  ...
  return (
    <div className="container-fluid p-0 p-md-4" style={{ background: "#f6f8fa", minHeight: "100vh" }}>
      {/* Tabs Navigation */}
      <div className="d-flex flex-column flex-md-row align-items-md-center border-bottom mb-4 overflow-auto"
        style={{
          background: "#fff",
          borderBottom: "1px solid #dee2e6",
        }}
      >
        <div className="d-flex flex-nowrap px-2 px-md-3" style={{ gap: "0.5rem" }}>
          {tabList.map((tab) => (
            <div
              key={tab.key}
            ...
            <div className="col-12">
              <div className="bg-white border rounded-3 p-3 p-md-4">
                <div className="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center mb-4">
                  <h4 className="mb-3 mb-md-0">Task lists</h4>
                ...
                <div className="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center mb-3 gap-2">
