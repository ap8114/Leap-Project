...
const TaskPage = () => {
  ...
  <div className="row justify-content-between align-items-center mb-4">
    ...
    <div className="col-6 col-md d-flex flex-wrap justify-content-md-end gap-2 mt-3 mt-md-0">
      <Link to="/taskfeed">
      ...
      <Button variant="custom" className="py-3 fw-light" onClick={handleOpen}>New task</Button>
    </div>
  </div>

  {/* Tabs & Filters */}
  <div className="row g-2 mb-3 bg-white rounded-3 p-3 shadow-sm">
    {/* Tabs */}
    <div className="col-6 col-md-auto">
      <div className="d-flex border border-custom rounded-3 overflow-hidden w-100" style={{ height: "40px" }}>
        <Button
        ...
        <Button
          ...
          className={`fw-light fs-5 px-2 py-1 h-100 rounded-0 border-0 flex-grow-1 ${activeTab === "completed" ? "active" : ""}`}
    ...
    <div className="col-12 col-md-auto py-1 mt-0">
      <Form.Control
        type="text"
        placeholder="Search"
        className="fw-light fs-5 h-100 border-custom w-100"
